...
set description=1.0.0-0-release
...
@echo>version.h.new #define CWSM_VERSION _T("%description%")
@echo>>version.h.new #define CWSM_VERSIONINFO %major%,%minor%,%n%,%BUILD_NUMBER%
@echo>>version.h.new #define CWSM_DATE _T("%DATE%")
@echo>>version.h.new #define CWSM_FILEFLAGS %flags%
@echo>>version.h.new #define CWSM_COPYRIGHT _T("Copyright (C) 2026 Chronexa. All rights reserved.")
