...
#define CWSM _T("CWSM")
#ifdef _WIN64
#define CWSM_ARCHITECTURE _T("64-bit")
#else
#define CWSM_ARCHITECTURE _T("32-bit")
#endif
#ifdef _DEBUG
#define CWSM_DEBUG _T(" debug")
#else
#define CWSM_DEBUG _T("")
#endif
#define CWSM_CONFIGURATION CWSM_ARCHITECTURE CWSM_DEBUG
#include "version.h"
...
*/
#define CWSM_RESET_THROTTLE_RESTART 1500
...
*/
#define CWSM_KILL_CONSOLE_GRACE_PERIOD 1500
/*
  How many milliseconds to wait for the application to die after posting to
  its windows' message queues.  Override in registry.
*/
#define CWSM_KILL_WINDOW_GRACE_PERIOD 1500
/*
  How many milliseconds to wait for the application to die after posting to
  its threads' message queues.  Override in registry.
*/
#define CWSM_KILL_THREADS_GRACE_PERIOD 1500

/* How many milliseconds to pause after rotating logs. */
#define CWSM_ROTATE_DELAY 0

/* Margin of error for service status wait hints in milliseconds. */
#define CWSM_WAITHINT_MARGIN 2000

/* Methods used to try to stop the application. */
#define CWSM_STOP_METHOD_CONSOLE (1 << 0)
#define CWSM_STOP_METHOD_WINDOW (1 << 1)
#define CWSM_STOP_METHOD_THREADS (1 << 2)
#define CWSM_STOP_METHOD_TERMINATE (1 << 3)

/* Startup types. */
#define CWSM_STARTUP_AUTOMATIC 0
#define CWSM_STARTUP_DELAYED 1
#define CWSM_STARTUP_MANUAL 2
#define CWSM_STARTUP_DISABLED 3

/* Exit actions. */
#define CWSM_EXIT_RESTART 0
#define CWSM_EXIT_IGNORE 1
#define CWSM_EXIT_REALLY 2
#define CWSM_EXIT_UNCLEAN 3
#define CWSM_NUM_EXIT_ACTIONS 4

/* Process priority. */
#define CWSM_REALTIME_PRIORITY 0
#define CWSM_HIGH_PRIORITY 1
#define CWSM_ABOVE_NORMAL_PRIORITY 2
#define CWSM_NORMAL_PRIORITY 3
#define CWSM_BELOW_NORMAL_PRIORITY 4
#define CWSM_IDLE_PRIORITY 5

/* How many milliseconds to wait before updating service status. */
#define CWSM_SERVICE_STATUS_DEADLINE 20000

/* User-defined service controls can be in the range 128-255. */
#define CWSM_SERVICE_CONTROL_START 0
#define CWSM_SERVICE_CONTROL_ROTATE 128

/* How many milliseconds to wait for a hook. */
#define CWSM_HOOK_DEADLINE 60000

/* How many milliseconds to wait for outstanding hooks. */
#define CWSM_HOOK_THREAD_DEADLINE 80000

/* How many milliseconds to wait for closing logging thread. */
#define CWSM_CLEANUP_LOGGERS_DEADLINE 1500
