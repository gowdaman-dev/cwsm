...
#define CWSM_STDIN_SHARING FILE_SHARE_WRITE
#define CWSM_STDIN_DISPOSITION OPEN_EXISTING
#define CWSM_STDIN_FLAGS FILE_ATTRIBUTE_NORMAL
#define CWSM_STDOUT_SHARING (FILE_SHARE_READ | FILE_SHARE_WRITE)
#define CWSM_STDOUT_DISPOSITION OPEN_ALWAYS
#define CWSM_STDOUT_FLAGS FILE_ATTRIBUTE_NORMAL
#define CWSM_STDERR_SHARING (FILE_SHARE_READ | FILE_SHARE_WRITE)
#define CWSM_STDERR_DISPOSITION OPEN_ALWAYS
#define CWSM_STDERR_FLAGS FILE_ATTRIBUTE_NORMAL
...
int get_output_handles(cwsm_service_t *, STARTUPINFO *);
int use_output_handles(cwsm_service_t *, STARTUPINFO *);
void close_output_handles(STARTUPINFO *);
void cleanup_loggers(cwsm_service_t *);
