...
#define CWSM_KERNEL_DRIVER _T("SERVICE_KERNEL_DRIVER")
#define CWSM_FILE_SYSTEM_DRIVER _T("SERVICE_FILE_SYSTEM_DRIVER")
#define CWSM_WIN32_OWN_PROCESS _T("SERVICE_WIN32_OWN_PROCESS")
#define CWSM_WIN32_SHARE_PROCESS _T("SERVICE_WIN32_SHARE_PROCESS")
#define CWSM_INTERACTIVE_PROCESS _T("SERVICE_INTERACTIVE_PROCESS")
#define CWSM_SHARE_INTERACTIVE_PROCESS CWSM_WIN32_SHARE_PROCESS _T("|") CWSM_INTERACTIVE_PROCESS
#define CWSM_UNKNOWN _T("?")

#define CWSM_ROTATE_OFFLINE 0
#define CWSM_ROTATE_ONLINE 1
#define CWSM_ROTATE_ONLINE_ASAP 2
...
void set_cwsm_service_defaults(cwsm_service_t *);
void cleanup_cwsm_service(cwsm_service_t *);
...
void set_service_environment(cwsm_service_t *);
void unset_service_environment(cwsm_service_t *);
int pre_install_service(int, TCHAR **);
int pre_remove_service(int, TCHAR **);
int pre_edit_service(int, TCHAR **);
int install_service(cwsm_service_t *);
int remove_service(cwsm_service_t *);
int edit_service(cwsm_service_t *, bool);
int control_service(unsigned long, int, TCHAR **, bool);
int control_service(unsigned long, int, TCHAR **);
void set_service_recovery(cwsm_service_t *);
int monitor_service(cwsm_service_t *);
int start_service(cwsm_service_t *);
int stop_service(cwsm_service_t *, unsigned long, bool, bool);
void CALLBACK end_service(void *, unsigned char);
void throttle_restart(cwsm_service_t *);
int await_single_handle(SERVICE_STATUS_HANDLE, SERVICE_STATUS *, HANDLE, TCHAR *, TCHAR *, unsigned long);
int list_cwsm_services(int, TCHAR **);
