...
#define CWSM_NATIVE_DEPENDONGROUP _T("DependOnGroup")
#define CWSM_NATIVE_DEPENDONSERVICE _T("DependOnService")
#define CWSM_NATIVE_DESCRIPTION _T("Description")
#define CWSM_NATIVE_DISPLAYNAME _T("DisplayName")
#define CWSM_NATIVE_ENVIRONMENT _T("Environment")
#define CWSM_NATIVE_IMAGEPATH _T("ImagePath")
#define CWSM_NATIVE_NAME _T("Name")
#define CWSM_NATIVE_OBJECTNAME _T("ObjectName")
#define CWSM_NATIVE_STARTUP _T("Start")
#define CWSM_NATIVE_TYPE _T("Type")
