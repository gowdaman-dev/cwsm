...
#define CWSM_LOCALSYSTEM_ACCOUNT _T("LocalSystem")
/* Other well-known accounts which can start a service without a password. */
#define CWSM_LOCALSERVICE_ACCOUNT _T("NT Authority\\LocalService")
#define CWSM_NETWORKSERVICE_ACCOUNT _T("NT Authority\\NetworkService")
/* Virtual service accounts. */
#define CWSM_VIRTUAL_SERVICE_ACCOUNT_DOMAIN _T("NT Service")
/* This is explicitly a wide string. */
#define CWSM_LOGON_AS_SERVICE_RIGHT L"SeServiceLogonRight"
